...
namespace Client.Formlhm.ServiceReferencePim {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="MultipleBagagesFault", Namespace="http://schemas.datacontract.org/2004/07/MyAirport.Pim.Entities")]
    [System.SerializableAttribute()]
    public partial class MultipleBagagesFault : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Client.Formlhm.ServiceReferencePim.BagageDefinition[] ListBagagesField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Client.Formlhm.ServiceReferencePim.BagageDefinition[] ListBagages {
            get {
    ...
    public interface IServicePim {
        ...
        Client.Formlhm.ServiceReferencePim.BagageDefinition GetBagageById(int idBagage);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePim/GetBagageById", ReplyAction="http://tempuri.org/IServicePim/GetBagageByIdResponse")]
        System.Threading.Tasks.Task<Client.Formlhm.ServiceReferencePim.BagageDefinition> GetBagageByIdAsync(int idBagage);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Client.Formlhm.ServiceReferencePim.MultipleBagagesFault), Action="http://tempuri.org/IServicePim/GetBagageByCodeIataMultipleBagagesFaultFault", Name="MultipleBagagesFault", Namespace="http://schemas.datacontract.org/2004/07/MyAirport.Pim.Entities")]
        Client.Formlhm.ServiceReferencePim.BagageDefinition GetBagageByCodeIata(string codeIata);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePim/GetBagageByCodeIata", ReplyAction="http://tempuri.org/IServicePim/GetBagageByCodeIataResponse")]
        System.Threading.Tasks.Task<Client.Formlhm.ServiceReferencePim.BagageDefinition> GetBagageByCodeIataAsync(string codeIata);
        ...
        int CreateBagage(Client.Formlhm.ServiceReferencePim.BagageDefinition bag);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePim/CreateBagage", ReplyAction="http://tempuri.org/IServicePim/CreateBagageResponse")]
        System.Threading.Tasks.Task<int> CreateBagageAsync(Client.Formlhm.ServiceReferencePim.BagageDefinition bag);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePimChannel : Client.Formlhm.ServiceReferencePim.IServicePim, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePimClient : System.ServiceModel.ClientBase<Client.Formlhm.ServiceReferencePim.IServicePim>, Client.Formlhm.ServiceReferencePim.IServicePim {
        ...
        public Client.Formlhm.ServiceReferencePim.BagageDefinition GetBagageById(int idBagage) {
            return base.Channel.GetBagageById(idBagage);
        }
        
        public System.Threading.Tasks.Task<Client.Formlhm.ServiceReferencePim.BagageDefinition> GetBagageByIdAsync(int idBagage) {
            return base.Channel.GetBagageByIdAsync(idBagage);
        }
        
        public Client.Formlhm.ServiceReferencePim.BagageDefinition GetBagageByCodeIata(string codeIata) {
            return base.Channel.GetBagageByCodeIata(codeIata);
        }
        
        public System.Threading.Tasks.Task<Client.Formlhm.ServiceReferencePim.BagageDefinition> GetBagageByCodeIataAsync(string codeIata) {
            return base.Channel.GetBagageByCodeIataAsync(codeIata);
        }
        
        public int CreateBagage(Client.Formlhm.ServiceReferencePim.BagageDefinition bag) {
            return base.Channel.CreateBagage(bag);
        }
        
        public System.Threading.Tasks.Task<int> CreateBagageAsync(Client.Formlhm.ServiceReferencePim.BagageDefinition bag) {
